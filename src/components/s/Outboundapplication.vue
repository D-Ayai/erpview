<template>
  <div id="file" style="width: 1000px" >
    ...
    <el-form :model="fileForm" :rules="rules" ref="fileForm" label-width="100px" class="demo-fileForm">
      ...
      <h3 style="color: darkgray">出库申请单:</h3>
      <el-form-item>
        <el-col :span="12">
          <el-form-item style="width:400px" label="出库人" prop="productName">
            <el-input v-model="fileForm.productName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="出库理由" prop="thirdKindName">
      ...
      <el-form-item>
        <el-col :span="12">
          <el-form-item label="归还时间" prop="firstKindName">
            <el-date-picker
              v-model="value3"
              type="datetime"
              placeholder="选择日期时间">
