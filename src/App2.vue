...
<div class="homeWrap">
  <el-container style="height:100%">
    <el-header height="100px">头部</el-header>
        ...
        <el-menu
          ...
          <el-submenu :index="parentmenu.id+''" v-for="parentmenu in menutable">
            <template slot="title">
              ...
              <span>{{parentmenu.kindName}}</span>
            </template>

            <el-menu-item-group>

              <el-menu-item  @click="addTab(childmenu.kindName,childmenu.linkUrl)" :index="childmenu.id+''" v-for="childmenu in parentmenu.childMenu">
                <i :class="childmenu.iconUrl"></i>{{childmenu.kindName}}
...
<script>
  ...
  import Welcome from "./components/Welcome";
    ...
    export default {
      ...
      methods: {
          getmenudata(){
            this.$axios.get("file/linkage.action").then((response)=>{
